...
This time an image name `peakhell.jpg` is given.

![peakhell](/05/peakhell.jpg)
...
There are detailed explanations on `with open` vs `open` [reddit](https://www.reddit.com/r/learnpython/comments/nfszml/with_open_vs_open_in_python/) and [stackoverflow](https://stackoverflow.com/questions/31334061/file-read-using-open-vs-with-open).
...
Changing the url from peak.html to [channel.html](http://www.pythonchallenge.com/pc/def/channel.html) takes you to level6. 
