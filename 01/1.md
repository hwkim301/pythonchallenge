...
The URL for level1 changed from `274877906944.html` to [map.html](http://www.pythonchallenge.com/pc/def/map.html)
...
![ciphertext](/01/level1_hints.png)
...
ROT13 shifts 13 letters as it says in the name. 
...
Reading [this](https://stackoverflow.com/questions/39675898/is-python-string-concatenation-bad-practice) post will explains the reason in detail.
...
Since the URL for level1 is `map.html` I should do the 2 letter shift on the word **map**. 

Passing the string `map` to `1.py` gives you `ocr`. 

Changing the URL from `map.html` to [ocr.html](http://www.pythonchallenge.com/pc/def/ocr.html) gets you to level2.  
