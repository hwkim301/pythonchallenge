...
**![bonus.jpg](/23/bonus.jpg)**


An image of a cow is given.


The HTML title is `what is this module?`.


Here are the comments in the page-source. 
...
It looks like the level has something to do with `this`. 

Python has a module named **[this](https://stackoverflow.com/questions/37301273/attributes-of-python-module-this)** which doesn't have a document. 
...
The `this` module in Python is an easter egg module. 

It's written by **[Tim Peters](https://en.wikipedia.org/wiki/Tim_Peters_(software_engineer))** the guy who wrote `Timsort` the sorting algorithm used in Python. 
