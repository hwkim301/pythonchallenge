...
You should try to read as many Python books as possible. I personally tink Python Challenge is for people who know Python code but just aren't familiar with using various modules and writing classes in Python. 
...
You can check the title by looking at the tab where you opened the pythonchallenge problem.

![title](warming_up.png)
...
Level0 has a picture of a old computer monitor.

![monitor](calc.jpg)

On the monitor is a yellow rectangle with `2**38` written on it. 
...
When I change the URL from [0](http://www.pythonchallenge.com/pc/def/0.html) to [274877906944](http://www.pythonchallenge.com/pc/def/274877906944.html) level0 changes to level1.


I'll try to explain the code and how to solve these problems in detail as much as possible because I struggled a lot when solving these problems on my own. 


The solutions or writeups were hard to understand at least for me. It might be because I'm dumb or something lol but anyways... 