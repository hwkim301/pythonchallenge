...
This time there isn't a HTML title nor an image instead it's a php file (linkedlist.php)

Changing the URL from linkedlist.html to [linkedlist.php](http://www.pythonchallenge.com/pc/def/linkedlist.php) takes you to a web page like before. 


The title of the HTML is `follow the chain` and again there's an image. 


![chainsaw](/04/chainsaw.jpg). 
...
In this case pass next nothings with `?`.
...
Changing the URL form linkedlist.php to [peak.html](http://www.pythonchallenge.com/pc/def/peak.html) takes you to level5.