...
This time a picture of clothes with a zipper is given. 

![zipper](/06/channel.jpg)
...
There weren't any more helpful hints.

So, I thought of changing the url from channel.html to [channel.zip](http://www.pythonchallenge.com/pc/def/channel.zip) as the hint told me to do. 
...
The code is pretty similar to the code in level 4.
...
What should I do to collect comments? Does zipfiles have hidden comments?
...
It looks like a type of ASCII art, so instead of just printing the gathered comments.

I unpacked the list using `*`. 
...
So I changed the URL from channel.html to [hockey.html](http://www.pythonchallenge.com/pc/def/hockey.html).
...
Changing the URL from hockey.html to [oxygen.html](http://www.pythonchallenge.com/pc/def/oxygen.html) takes you to level 7. 