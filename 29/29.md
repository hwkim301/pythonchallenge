...
Using **[enumerate](https://docs.python.org/3/library/functions.html#enumerate)** will tell you the index where the html tag ends. Index 12 is where the actual data other than the html tags start.
