...
It's a book. The HTML title is `ocr`. 
...
Save the mess into a file and use grep to grab only the alphabets. 
...
Changing the URL from ocr.html to [equality.html](http://www.pythonchallenge.com/pc/def/equality.html) takes you to level3.